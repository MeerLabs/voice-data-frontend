...
def upload_file_to_azure(fpath, fname):
    ...
    service_client = ShareFileClient.from_connection_string(conn_str, share_name=share_name, file_path=f'{fname}-{timestamp_str}.opus')
...
if __name__ == "__main__":
    ...
    upload_file_to_azure(fpath, fname)
